...
class TestDataIntegrity(unittest.TestCase):
    ...
    def test_temporal_integrity_validation(self):
        ...
        # Create overlapping data (should raise exception)
        ...
        # Should raise TemporalLeakageError when leakage is detected
        with self.assertRaises(Exception) as context:
            self.data_processor.validate_temporal_integrity(train_df, bad_test_df)
        
        # Verify the exception message contains leakage detection info
