...
FORECAST_MODEL = "rf"  # Options: "rf", "linear" 
# - "rf": Random Forest (primary model - uses Random Forest for both regression & classification)
# - "linear": Linear Models (uses Linear Regression for regression, Logistic for classification)
# Note: Random Forest is recommended for best performance, linear/logistic for interpretability
